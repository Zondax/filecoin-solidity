...
fn miner_tests() {
    ...
    let message = Message {
        ...
        sequence: 2,
        params: RawBytes::new(hex::decode("").unwrap()),
        ..Message::default()
    };
    ...
    let message = Message {
        ...
        method_num: EvmMethods::InvokeContract as u64,
        sequence: 4,
        params: RawBytes::new(hex::decode("").unwrap()),
        ..Message::default()
    };
    ...
    let message = Message {
        ...
        method_num: EvmMethods::InvokeContract as u64,
        sequence: 12,
        params: RawBytes::new(hex::decode("").unwrap()),
        ..Message::default()
    };
    ...
    let message = Message {
       ...
       method_num: EvmMethods::InvokeContract as u64,
       sequence: 13,
       params: RawBytes::new(hex::decode("").unwrap()),
       ..Message::default()
    };
    ...
    let message = Message {
        ...
        method_num: EvmMethods::InvokeContract as u64,
        sequence: 15,
        params: RawBytes::new(hex::decode("").unwrap()),
        ..Message::default()
    };
    ...
    let message = Message {
        ...
        method_num: EvmMethods::InvokeContract as u64,
        sequence: 17,
        params: RawBytes::new(hex::decode("").unwrap()),
        ..Message::default()
    };
