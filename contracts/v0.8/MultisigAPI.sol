...
library MultisigAPI {
    ...
    function propose(bytes memory target, MultisigTypes.ProposeParams memory params) internal returns (MultisigTypes.ProposeReturn memory) {
        ...
        bytes memory raw_response = Actor.call(MultisigTypes.ProposeMethodNum, target, raw_request, Misc.DAG_CBOR_CODEC, msg.value, false);
    ...
    function propose(uint64 target, MultisigTypes.ProposeParams memory params) internal returns (MultisigTypes.ProposeReturn memory) {
        ...
        bytes memory raw_response = Actor.callByID(target, MultisigTypes.ProposeMethodNum, Misc.DAG_CBOR_CODEC, raw_request, msg.value, false);
    ...
    function approve(bytes memory target, MultisigTypes.TxnIDParams memory params) internal returns (MultisigTypes.ApproveReturn memory) {
        ...
        bytes memory raw_response = Actor.call(MultisigTypes.ApproveMethodNum, target, raw_request, Misc.DAG_CBOR_CODEC, msg.value, false);
    ...
    function approve(uint64 target, MultisigTypes.TxnIDParams memory params) internal returns (MultisigTypes.ApproveReturn memory) {
        ...
        bytes memory raw_response = Actor.callByID(target, MultisigTypes.ApproveMethodNum, Misc.DAG_CBOR_CODEC, raw_request, msg.value, false);
    ...
    function cancel(bytes memory target, MultisigTypes.TxnIDParams memory params) internal {
        ...
        bytes memory raw_response = Actor.call(MultisigTypes.CancelMethodNum, target, raw_request, Misc.DAG_CBOR_CODEC, msg.value, false);
    ...
    function cancel(uint64 target, MultisigTypes.TxnIDParams memory params) internal {
        ...
        bytes memory raw_response = Actor.callByID(target, MultisigTypes.CancelMethodNum, Misc.DAG_CBOR_CODEC, raw_request, msg.value, false);
    ...
    function addSigner(bytes memory target, MultisigTypes.AddSignerParams memory params) internal {
        ...
        bytes memory raw_response = Actor.call(MultisigTypes.AddSignerMethodNum, target, raw_request, Misc.DAG_CBOR_CODEC, msg.value, false);
    ...
    function addSigner(uint64 target, MultisigTypes.AddSignerParams memory params) internal {
        ...
        bytes memory raw_response = Actor.callByID(target, MultisigTypes.AddSignerMethodNum, Misc.DAG_CBOR_CODEC, raw_request, msg.value, false);
    ...
    function removeSigner(bytes memory target, MultisigTypes.RemoveSignerParams memory params) internal {
        ...
        bytes memory raw_response = Actor.call(MultisigTypes.RemoveSignerMethodNum, target, raw_request, Misc.DAG_CBOR_CODEC, msg.value, false);
    ...
    function removeSigner(uint64 target, MultisigTypes.RemoveSignerParams memory params) internal {
        ...
        bytes memory raw_response = Actor.callByID(target, MultisigTypes.RemoveSignerMethodNum, Misc.DAG_CBOR_CODEC, raw_request, msg.value, false);
    ...
    function swapSigner(bytes memory target, MultisigTypes.SwapSignerParams memory params) internal {
        ...
        bytes memory raw_response = Actor.call(MultisigTypes.SwapSignerMethodNum, target, raw_request, Misc.DAG_CBOR_CODEC, msg.value, false);
    ...
    function swapSigner(uint64 target, MultisigTypes.SwapSignerParams memory params) internal {
        ...
        bytes memory raw_response = Actor.callByID(target, MultisigTypes.SwapSignerMethodNum, Misc.DAG_CBOR_CODEC, raw_request, msg.value, false);
    ...
    function changeNumApprovalsThreshold(bytes memory target, MultisigTypes.ChangeNumApprovalsThresholdParams memory params) internal {
        ...
        bytes memory raw_response = Actor.call(MultisigTypes.ChangeNumApprovalsThresholdMethodNum, target, raw_request, Misc.DAG_CBOR_CODEC, msg.value, false);
    ...
    function changeNumApprovalsThreshold(uint64 target, MultisigTypes.ChangeNumApprovalsThresholdParams memory params) internal {
        ...
        bytes memory raw_response = Actor.callByID(target, MultisigTypes.ChangeNumApprovalsThresholdMethodNum, Misc.DAG_CBOR_CODEC, raw_request, msg.value, false);
    ...
    function lockBalance(bytes memory target, MultisigTypes.LockBalanceParams memory params) internal {
        ...
        bytes memory raw_response = Actor.call(MultisigTypes.LockBalanceMethodNum, target, raw_request, Misc.DAG_CBOR_CODEC, msg.value, false);
    ...
    function lockBalance(uint64 target, MultisigTypes.LockBalanceParams memory params) internal {
        ...
        bytes memory raw_response = Actor.callByID(target, MultisigTypes.LockBalanceMethodNum, Misc.DAG_CBOR_CODEC, raw_request, msg.value, false);
    ...
    function universalReceiverHook(bytes memory target, bytes memory params) internal {
        ...
        bytes memory raw_response = Actor.call(MultisigTypes.UniversalReceiverHookMethodNum, target, raw_request, Misc.DAG_CBOR_CODEC, msg.value, false);
    ...
    function universalReceiverHook(uint64 target, bytes memory params) internal {
        ...
        bytes memory raw_response = Actor.callByID(target, MultisigTypes.UniversalReceiverHookMethodNum, Misc.DAG_CBOR_CODEC, raw_request, msg.value, false);
