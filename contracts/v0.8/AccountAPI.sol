...
library AccountAPI {
    ...
    function authenticateMessage(bytes memory target, AccountTypes.AuthenticateMessageParams memory params) internal {
        ...
        bytes memory raw_response = Actor.call(AccountTypes.AuthenticateMessageMethodNum, target, raw_request, Misc.DAG_CBOR_CODEC, msg.value, false);
    ...
    function authenticateMessage(uint64 target, AccountTypes.AuthenticateMessageParams memory params) internal {
        ...
        bytes memory raw_response = Actor.callByID(target, AccountTypes.AuthenticateMessageMethodNum, Misc.DAG_CBOR_CODEC, raw_request, msg.value, false);
    ...
    function universalReceiverHook(bytes memory target, AccountTypes.UniversalReceiverParams memory params) internal {
        ...
        bytes memory raw_response = Actor.call(AccountTypes.UniversalReceiverHookMethodNum, target, raw_request, Misc.DAG_CBOR_CODEC, msg.value, false);
    ...
    function universalReceiverHook(uint64 target, AccountTypes.UniversalReceiverParams memory params) internal {
        ...
        bytes memory raw_response = Actor.callByID(target, AccountTypes.UniversalReceiverHookMethodNum, Misc.DAG_CBOR_CODEC, raw_request, msg.value, false);
