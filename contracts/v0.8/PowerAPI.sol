...
library PowerAPI {
    ...
    function createMiner(PowerTypes.CreateMinerParams memory params, uint256 value) internal returns (PowerTypes.CreateMinerReturn memory) {
        ...
        bytes memory raw_response = Actor.callByAddress(PowerTypes.CreateMinerMethodNum, PowerTypes.ActorID, raw_request, Misc.CBOR_CODEC, value, false);
    ...
    function minerCount() internal returns (uint64) {
        ...
        bytes memory raw_response = Actor.callByAddress(PowerTypes.MinerCountMethodNum, PowerTypes.ActorID, raw_request, Misc.NONE_CODEC, 0, true);
    ...
    function minerConsensusCount() internal returns (int64) {
        ...
        bytes memory raw_response = Actor.callByAddress(PowerTypes.MinerConsensusCountMethodNum, PowerTypes.ActorID, raw_request, Misc.NONE_CODEC, 0, true);
    ...
    function networkRawPower() internal returns (BigInt memory) {
        ...
        bytes memory raw_response = Actor.callByAddress(PowerTypes.NetworkRawPowerMethodNum, PowerTypes.ActorID, raw_request, Misc.NONE_CODEC, 0, true);
    ...
    function minerRawPower(uint64 minerID) internal returns (PowerTypes.MinerRawPowerReturn memory) {
        ...
        bytes memory raw_response = Actor.callByAddress(PowerTypes.MinerRawPowerMethodNum, PowerTypes.ActorID, raw_request, Misc.CBOR_CODEC, 0, true);
