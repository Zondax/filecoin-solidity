...
contract Leb128Generated4Test {
    ...
    function unsiged_integer_leb128_encoding_generated() public pure {
        ...
        bytes memory expected279 = hex"9352";
        uint64 value279 = 10515;

        Buffer.buffer memory result279 = Leb128.encodeUnsignedLeb128FromUInt64(value279);

        require(keccak256(result279.buf) == keccak256(expected279), "'10515' is not returning '9352'");    
