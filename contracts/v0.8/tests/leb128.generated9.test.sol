...
contract Leb128Generated9Test {
    ...
    function unsiged_integer_leb128_encoding_generated() public pure {
        ...
        bytes memory expected699 = hex"d4e4aed201";
        uint64 value699 = 441168468;

        Buffer.buffer memory result699 = Leb128.encodeUnsignedLeb128FromUInt64(value699);

        require(keccak256(result699.buf) == keccak256(expected699), "'441168468' is not returning 'd4e4aed201'");    
        ...
        bytes memory expected769 = hex"e0e0f0bebbecb2ddc901";
        uint64 value769 = 14536154376438558816;

        Buffer.buffer memory result769 = Leb128.encodeUnsignedLeb128FromUInt64(value769);

        require(keccak256(result769.buf) == keccak256(expected769), "'14536154376438558816' is not returning 'e0e0f0bebbecb2ddc901'");    
