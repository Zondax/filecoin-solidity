...
contract Leb128Generated1Test {
    ...
    function unsiged_integer_leb128_encoding_generated() public pure {
        ...
        bytes memory expected69 = hex"64";
        uint64 value69 = 100;

        Buffer.buffer memory result69 = Leb128.encodeUnsignedLeb128FromUInt64(value69);

        require(keccak256(result69.buf) == keccak256(expected69), "'100' is not returning '64'");    
